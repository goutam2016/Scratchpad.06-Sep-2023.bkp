...
4.	Using Spark Standalone Cluster
	...
	%SPARK_HOME%\bin\spark-submit --class org.gb.sample.spark.nytaxitrips.TripStatsPerTimeBandMain --properties-file simple-spark/conf/standalone.properties simple-spark/target/simple-spark-0.0.1-SNAPSHOT.jar simple-spark/data/nytaxitrips/yellow_tripdata_100000.csv
