...
7.	Using Spark Standalone Cluster
	...
	%SPARK_HOME%\bin\spark-submit --class org.gb.sample.spark.income.Main --properties-file simple-spark/conf/standalone.properties simple-spark/target/uber-simple-spark-0.0.1-SNAPSHOT.jar simple-spark/data/income/name-vs-income_500.txt simple-spark/data/income/person-profile_500.txt
